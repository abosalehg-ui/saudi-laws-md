...
_NOISE_PATTERNS = (
    ...
    "عدد القراءات",
    "جميع الحقوق محفوظة",
    # زر تبديل اللغة ملتصقًا بسطر تاريخ الإصدار: توقيع صفحات qanoonsa
    # المكرّرة (‎/p/<id>-2/‎) التي تُعيد نشر وثيقة بلا متنها، فلا يبقى في
    # المتن سوى هذا السطر — وثيقة جوفاء تمرّ كأنها وثيقة نثرية صحيحة
    "English صدر في",
)
