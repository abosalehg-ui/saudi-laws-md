...
ARTICLE_PAGE = (
    ...
    "<h2>المادة الأولى</h2><p>نص المادة الأولى: يسري هذا النظام على جميع "
    "المنشآت وفروعها العاملة في المملكة، ويُعمل به بعد مضي تسعين يومًا "
    "من تاريخ نشره.</p></div></html>"
)
PROSE_PAGE = (
    '<html><h1>{title}</h1><div class="entry-content">'
    "<p>فقرة نثرية بلا أي تقطيع لمواد، طويلة بما يكفي لتجاوز الحدّ الأدنى "
    "لمتن الوثيقة، حتى لا يعدّها حارس الوثيقة الجوفاء ناتجًا فارغًا."
    "</p></div></html>"
)
